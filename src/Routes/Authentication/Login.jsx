...
function Login() {
    ...
    return (
        <div className='bg-gray-100 md:overflow-y-scroll pb-10 md:pb-0 w-screen h-screen relative  flex flex-col md:flex-row-reverse justify-center md:justify-start items-center'>
            <img src="https://img.freepik.com/free-photo/side-view-fried-meat-with-french-fries-ketchup_141793-4908.jpg?w=826&t=st=1680031687~exp=1680032287~hmac=f89ac19f8899819e9196ebb6904a5510b079852e5f8c5085b245af405b6a202b" alt='image' className='w-full md:hidden block h-[25%]  bg-gray-300 object-cover' />
